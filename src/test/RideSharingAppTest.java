...
import main.Data.*;
import main.controller.RideController;
import main.controller.UserRegistrationController;
import main.controller.VehicleRegistrationController;
...
public class RideSharingAppTest {
    ...
    public void RideSharingAppTest() {
        ...
        Vehicle shipraActivaVehicle = vehicleRegistrationController.createVehicle(shipra,"Activa", "KA-12-12332");
        ...
        Ride shipraScootyBanMysRide = rideController.createRide(shipra, shipraActivaVehicle, City.BANGALORE,City.MYSORE,1,new Date(2019, 1, 29,18,0),10);
